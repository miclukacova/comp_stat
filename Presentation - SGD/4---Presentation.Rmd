...
d_gd3 <- plot_data(gd3)
#Vanilla SGD
sgd1 <- SGD(par0 = start_p, grad = grad, gamma = decaySGD, x = sim1$x, y = sim1$y, true_par = param$par)
sgd2 <- SGD(par0 = start_p, grad = grad, gamma = decaySGD, x = sim2$x, y = sim2$y, true_par = param$par)
sgd3 <- SGD(par0 = start_p, grad = grad, gamma = decaySGD, x = sim3$x, y = sim3$y, true_par = param$par)
d_sgd1 <- plot_data(sgd1)
d_sgd2 <- plot_data(sgd2)
d_sgd3 <- plot_data(sgd3)
#Minibatch
mb1 <- SGD(par0 = start_p, grad = grad_mult, gamma = decayMB, epoch = batch, m = 25, x = sim1$x, y = sim1$y, true_par = param$par)
mb2 <- SGD(par0 = start_p, grad = grad_mult, gamma = decayMB, epoch = batch, m = 25, x = sim2$x, y = sim2$y, true_par = param$par)
mb3 <- SGD(par0 = start_p, grad = grad_mult, gamma = decayMB, epoch = batch, m = 25, x = sim3$x, y = sim3$y, true_par = param$par)
d_mb1 <- plot_data(mb1)
d_mb2 <- plot_data(mb2)
d_mb3 <- plot_data(mb3)
```
