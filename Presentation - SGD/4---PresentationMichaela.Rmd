...
We do a naive test of the algorithm.  
...
And run the algorithm with 3 different starting values: the true values, $(1,1,1,1)$ and random values $(2.63, 1.64, 1.00, 0.49)$. 
...
Very different convergence schemes. 
